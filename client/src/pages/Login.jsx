    ...
    <div className="min-h-screen flex items-center justify-center p-6 bg-surface relative">
      ...
      <div className="w-full max-w-md space-y-8 animate-fade-in relative z-10">
        ...
        <div className="text-center">
          ...
          <p className="text-white/30 text-sm mt-2 font-medium">Authenticate to NebulaFin Matrix</p>
          <div className="flex items-center justify-center gap-2 mt-3">
            <Shield className="h-3 w-3 text-brand/60" />
            <span className="text-[10px] text-white/20 font-semibold uppercase tracking-[0.3em]">Encrypted Connection</span>
          </div>
        </div>
        ...
        <div className="card card-glow p-8 relative overflow-hidden">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <button type="submit" disabled={loading} className="btn-blue w-full py-4 text-base">
              {loading ? (
          ...
          <div className="mt-6 pt-6 border-t border-white/10 text-center">
            <p className="text-white/40 text-sm">
              No identity profile?{" "}
              <Link to="/register" className="text-brand hover:text-brand-light font-bold transition-colors">
                Create Identity →
              </Link>
            </p>
          </div>
